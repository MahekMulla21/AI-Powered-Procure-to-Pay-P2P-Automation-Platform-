...
PDF_PATH = os.path.join(BASE_DIR, "MSA_data/input/msa.pdf")
IMAGE_DIR = os.path.join(BASE_DIR, "MSA_data/images/")
...
#FAISS_INDEX_PATH = os.path.join(OUTPUT_DIR, "msa.index")
